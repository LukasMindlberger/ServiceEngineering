    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Request request = new Request.Builder()
                    .url("http://192.168.0.112:8081/login") //Bei externem Gerät nicht 'localhost' oder '127.0.0.1' verwenden sondern IPv4 Addresse des Host Computers (Wenn in selbem Netzwerk)
